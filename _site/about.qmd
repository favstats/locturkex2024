  ...
  div(
    ...
    div(
      ...
      div(  # Wrapped the image in another div to center it horizontally
        ...
        img(
          class = "card-img", 
          src = "https://github.com/favstats/ys24/blob/main/logs/onur.jpg?raw=true",
    ...
    div(
      ...
      div(
        ...
        p(
          class = "card-text", 
          "Onurcan Güden is a PhD candidate in Media and Communication Studies at the Galatasaray University and a visiting researcher at the University of Amsterdam. His research focuses on the impact of computational propaganda in shaping digital political agendas in different democracies and its societal consequences."
        )
      )
    )
  )
