...
cities_data <- data.frame(
  ...
  left_join(cityyyy %>% rename(name = city, z = spend_30days_bf_march4_2024)) %>% 
...
cities_data <- cities_data %>% 
  mutate(url = paste0("https://favstats.github.io/locturkex2024/docs/", stringr::str_to_lower(cities_data$name))) %>% 
